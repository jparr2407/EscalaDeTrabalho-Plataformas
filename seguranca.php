...
<div class="header">
    ...
    <img src="image/logo-Vital.gif" alt="Sua imagem" style="float: left; margin-right: 20px; margin-left: 12px; width: 100px; height: auto;">
...
// Mostrar s� o dia de hoje
$strSQL = "SELECT * FROM $table WHERE setor LIKE '%Seguran%' AND DATE(dt_plantao) >= CURDATE() ORDER BY dt_plantao, hora_ent, funcao, nome";
...
echo "<table class='table table-hover table-bordered espace'>
		 <caption><h3>Escala Segurança (A partir de Hoje)</h3></caption>
		 <thead>
			<tr>
				<th>Nome</th>
				<th>Celular</th>
...
?> 
	...
	var seconds = 60; // TEMPO EM SEGUNDOS EM QUE HAVERHAVER� O REDIRECIONAMENTO
	function CountDown(){
	    var now = new Date();
	    ...
	    if(counter > 0){
			...
			window.location = "seguranca.php"; //URL DA PAGINA A SER REDIRECIONADA
		}
	}
...
<html lang='pt-BR'>
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
		  ...
		  height: 650,
		  events: 'seguranca_get_events.php',
		  locale: 'pt-br',
		  eventTimeFormat: {
			hour: '2-digit',
			minute: '2-digit',
  ...
  <body>
	...
	<h3>Visão Geral Escala Segurança</h3>
	</div>
    <div id='calendar'></div>
  </body>
</html>
