...
$strSQL = "SELECT * FROM $table WHERE setor LIKE '%Torre%' AND DATE(dt_plantao) >= CURDATE() ORDER BY dt_plantao, hora_ent, funcao, nome";
...
echo "<table class='table table-hover table-bordered espace'>
		 <caption><h3>Escala Gestão Torre BA (A partir de Hoje)</h3></caption>
		 <thead>
			<tr>
				<th>Nome</th>
				<th>Celular</th>
...
?> 
	...
	function CountDown(){
	    ...
	    if(counter > 0){
			...
			window.location = "torre_ba.php"; //URL DA PAGINA A SER REDIRECIONADA
		}
	}
...
<html lang='pt-BR'>
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
		  ...
		  height: 650,
		  events: 'torre_ba_get_events.php',
		  locale: 'pt-br',
		  eventTimeFormat: {
			hour: '2-digit',
			minute: '2-digit',
  ...
  <body>
	...
	<h3>Visão Geral Escala Gestão Torre BA</h3>
	</div>
    <div id='calendar'></div>
  </body>
</html>
